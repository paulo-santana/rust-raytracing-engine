...
pub struct Vec3(pub [f64; 4], f64x4);

#[cfg(not(feature = "portable_simd"))]
#[derive(Debug, Clone, Copy)]
pub struct Vec3(pub(crate) [f64; 4]);
...
impl Vec3 {
    ...
    pub fn new(r: f64, g: f64, b: f64) -> Vec3 {
        let values = [r, g, b, 0.0];
        let simd = f64x4::from_slice(&values);
        Vec3(values, simd)
    }
...
impl Vec3 {
    ...
    pub fn from_array(array: &[f64; 4]) -> Vec3 {
        Vec3(*array, f64x4::from_slice(array))
    }
